...
const roboticsSandboxArticle = {
  ...
  ArticleBody: {
    SectionBlurb: {
      text: "I have always wanted to build a tool to help visualize complex mapping and control algorithms. I finally got a chance to build it.",
    },
    ...
    Entries: [
      ...
      {
        type: "SectionEntry",
        text: "Click here to check out the project live! https://ofekperes.github.io/controls-visualization/",
        link: true,
...
export default RoboticsSandboxArticle
